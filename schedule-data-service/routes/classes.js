...
module.exports = function (server, db) {
  ...
  server.get('/data/classes', (req, res) => {
    let query = "SELECT id, name,shortName,school,blog,hide,defaultStartTime,defaultEndTime,defaultInvoiceItem,defaultHoursPerDay FROM classes"
  ...
  server.get('/data/classes/:id', (req, res) => {
    let query = "SELECT id, name,shortName,school,blog,hide,defaultStartTime,defaultEndTime,defaultInvoiceItem,defaultHoursPerDay FROM classes WHERE id=@id"
